    ...
    return (
      <div className="appointment-wrapper">
        ...
        <div className="appointment-actions preview-actions">
          <button className="cancel-btn" onClick={onBack}>Ακύρωση</button>
...
// // Μετακίνησε το BookAppointmentStep σε ξεχωριστό component ΕΞΩ από το κύριο component
// const BookAppointmentStep = React.memo(({ 
//   vet, 
//   pets, 
//   selectedPet, 
//   setSelectedPet,
...
//         {/* ΠΕΡΙΓΡΑΦΗ - ΑΥΤΟ ΕΙΝΑΙ ΤΟ ΠΡΟΒΛΗΜΑ */}
//         <div className="form-group full-width">
//           <label>Σύντομη Περιγραφή (προαιρετικά)</label>
//           <textarea 
//             value={description}
//             maxLength={200}
//             onChange={(e) => {
//               // Κρίσιμο: χρησιμοποιούμε requestAnimationFrame για να αποφύγουμε blocking
//               requestAnimationFrame(() => {
//                 setDescription(e.target.value);
//               });
//             }}
//             onKeyDown={(e) => {
//               // Αυτό βοηθάει να κρατήσει την εστίαση
//               e.stopPropagation();
//             }}
//             placeholder="Περιγράψτε εν συντομία το πρόβλημα ή τον λόγο της επίσκεψης..."
//             rows="3"
...
// // Μετακίνησε και το PreviewAppointmentStep
// const PreviewAppointmentStep = React.memo(({ 
//   vet, 
//   myPets, 
//   selectedPet, 
//   selectedDate, 
...
//   // Χρησιμοποιούμε useMemo για να αποφύγουμε αναμοντάρισμα
...
//     return result;
//   }, [allVeterinarians, region, experience, date, specialization, education, gender, timeFrom, timeTo, sortOrder, step]);
...
//     );
//   }, [
//     region, experience, date, specialization, timeFrom, education, timeTo, gender,
//     availableDates, REGIONS, EXPERIENCE_OPTIONS, specializationOptions, educationOptions,
//     VET_GENDERS, sortOrder, veterinarians, filteredVeterinarians
//   ]);
