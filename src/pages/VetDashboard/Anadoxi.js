...
export default function Foster() {
  ...
  const handleCancel = () => {
    const confirmLeave = window.confirm("Αν ακυρώσετε, τα στοιχεία της δήλωσης δεν θα αποθηκευτούν.\nΘέλετε σίγουρα να συνεχίσετε;");
  ...
  const handleSearchByMicrochip = async () => {
    ...
    try {
      ...
      if (foundPet.status !== "adoption") {
        setErrors({ microchip: "Το κατοικίδιο δεν είναι διαθέσιμο για αναδοχή." });
        setSelectedPet(null);
        return;
      }
      ...
      if (!okOwner) {
        setErrors({ microchip: "Δεν βρέθηκαν στοιχεία υπεύθυνου για αυτό το κατοικίδιο" });
        setSelectedPet(null);
        return;
      }
      setStep(2);
  ...
  const handleSubmit = async (status) => {
    ...
    try {
      const report = {
        ...
        fosterOwnerId: newOwnerFound.data.id,
        fosterDate: new Date().toISOString().split("T")[0],
        status,
        ...
        <>
          <div className="stepper">
            ...
            <div className="step step-zero">
              ...
              <span>Στο δεύτερο βήμα επιβεβαιώνετε τα στοιχεία του κατοικιδίου.</span>
            </div>
            <div className="line" />
            <div className="step step-zero">
              <div className="circle">3</div>
              <span>Στο τρίτο βήμα εισάγετε ΑΦΜ αναδόχου. Αν δεν υπάρχει, δημιουργείτε λογαριασμό.</span>
            </div>
            <div className="line" />
            <div className="step step-zero">
      ...
      {step === 1 && (
        <>
          <div className="stepper">
            ...
            <div className="step">
              <div className="circle">3</div>
              <div className="step-title">Ανάδοχος</div>
            </div>
            <div className="line" />
            <div className="step">
              <div className="circle">4</div>
          ...
          <div className="found-form">
            ...
            {showOwnerRegister && (
              <div className="ownerRegister">
                <h4>Δημιουργία Λογαριασμού Αναδόχου (Δεν υπάρχει λογαριασμός με αυτό το ΑΦΜ)</h4>
      ...
      {step === 4 && selectedPet && currentOwner && newOwnerFound && (
        <>
          ...
          <div className="booklet-container">
            <h3>Προεπισκόπηση Δήλωσης Αναδοχής</h3>
              ...
              <div className="booklet-header">
                ...
                <div className="booklet-top">
                  <div className="info-box">
                    ...
                    <p><span>Ημερομηνία Γέννησης:</span> {selectedPet.birthdate || "-"}</p>
                    <p><span>Περιοχή:</span> {selectedPet.region || "-"}</p>
                    <p><span>Status:</span> {selectedPet.status}</p>
                  </div>
