  ...
  return (
    <div className={`pet-card-x pet-card-profile ${selected ? "selected" : ""}`} >
      ...
      <div className="pet-fields">
        ...
        <div className="pet-row">
          <span>
            {isLost ? "Ημερομηνία Εξαφάνισης" : "Ημερομηνία Εμφάνισης"}
          </span>
        ...
        <div className="pet-row">
          <span>
            {isLost ? "Περιοχή Εξαφάνισης (Νομός)" : "Περιοχή Εμφάνισης (Νομός)"}
          </span>
          <b>{pet.region || "-"}</b>
        </div>
        ...
        <div className="pet-row">
          <span>
            {isLost ? "Διεύθυνση Εξαφάνισης" : "Διεύθυνση Εμφάνισης"}
          </span>
